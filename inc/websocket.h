...
typedef int (*ConnCallback)(WebSocketServer *server, int client, void *environment);
typedef int (*ReadCallback)(WebSocketServer *server, int client, unsigned char *buffer, size_t read, int status, void *environment);
